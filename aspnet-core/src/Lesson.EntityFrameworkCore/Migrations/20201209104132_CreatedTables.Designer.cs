...
namespace Lesson.Migrations
{
    ...
    [Migration("20201209104132_CreatedTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FileHomework", b =>
                {
                    ...
                    b.HasKey("FilesId", "HomeworksId");

                    b.HasIndex("HomeworksId");

                    b.ToTable("FileHomework");
                });
            ...
            modelBuilder.Entity("Lesson.Domain.ClassRoom.ClassRoom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Lesson.Domain.Entities.File", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("SubmittedHomeworkId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SubmittedHomeworkId");

                    b.ToTable("Files");
                });

            modelBuilder.Entity("Lesson.Domain.Entities.Homework", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Lesson.Domain.Entities.SubmittedHomework", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Lesson.Domain.Entities.WatchInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Lesson.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Lesson.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ClassRoomLesson", b =>
                {
                    b.HasOne("Lesson.Domain.ClassRoom.ClassRoom", null)
                        .WithMany()
                        .HasForeignKey("ClassRoomsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Lesson.Domain.Entities.Lesson", null)
                        .WithMany()
            ...
            modelBuilder.Entity("FileHomework", b =>
                {
                    b.HasOne("Lesson.Domain.Entities.File", null)
                        .WithMany()
                        .HasForeignKey("FilesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Lesson.Domain.Entities.Homework", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Lesson.Domain.Entities.File", b =>
                {
                    b.HasOne("Lesson.Domain.Entities.SubmittedHomework", null)
                        .WithMany("Files")
                        .HasForeignKey("SubmittedHomeworkId");
                });

            modelBuilder.Entity("Lesson.Domain.Entities.Homework", b =>
                {
                    b.HasOne("Lesson.Domain.ClassRoom.ClassRoom", "ClassRoom")
                        .WithMany()
                    ...
                    b.HasOne("Lesson.Authorization.Users.User", "Teacher")
                        .WithMany()
            ...
            modelBuilder.Entity("Lesson.Domain.Entities.SubmittedHomework", b =>
                {
                    b.HasOne("Lesson.Domain.Entities.Homework", "Homework")
                        .WithMany()
                        .HasForeignKey("HomeworkId");

                    b.HasOne("Lesson.Authorization.Users.User", "Student")
                        .WithMany()
            ...
            modelBuilder.Entity("Lesson.Domain.Entities.WatchInfo", b =>
                {
                    b.HasOne("Lesson.Domain.Entities.File", "File")
                        .WithMany("WatchInfos")
                        .HasForeignKey("FileId");

                    b.HasOne("Lesson.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
